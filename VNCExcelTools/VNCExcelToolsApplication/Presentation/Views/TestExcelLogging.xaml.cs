...
{
    public partial class TestExcelLogging : ViewBase, ITestExcelLogging, IInstanceCountV
    {
        #region Fields (none)
        ...
        public TestExcelLogging()
        {
            ...
            // ViewModel = (ITestExcelLoggingViewModel)DataContext;

            // Can create directly

            // ViewModel = TestExcelLoggingViewModel();

            // ViewModel = new TestExcelLoggingViewModel(
        ...
        public TestExcelLogging(ITestExcelLoggingViewModel viewModel)
        {
