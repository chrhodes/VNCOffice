...
{
    public class BevelPropertiesRowWrapper : ModelWrapper<VNCVisioAddIn.Domain.BevelPropertiesRow>
    {
        public BevelPropertiesRowWrapper()
        {
        }
        public BevelPropertiesRowWrapper(VNCVisioAddIn.Domain.BevelPropertiesRow model) : base(model)
        {
        }
