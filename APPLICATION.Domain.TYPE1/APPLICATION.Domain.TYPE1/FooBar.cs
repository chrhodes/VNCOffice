...
{
    public class FooBar : IEntity<int>, IModificationHistory, IOptimistic
    {
        public FooBar()
        {
            PhoneNumbers = new Collection<FooBarPhoneNumber>();
        ...
        public ICollection<FooBarPhoneNumber> PhoneNumbers { get; set; }
