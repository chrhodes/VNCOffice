...
namespace VNCVisioToolsApplication.Visio
{
    public class AddInApplication
    {
        ...
        {
            Int64 startTicks =0;
            if (Common.VNCLogLevel.ApplicationEnd) startTicks = Log.APPLICATION_END("Enter", Common.LOG_CATEGORY);
            ...
            if (Common.VNCLogLevel.ApplicationEnd) Log.APPLICATION_END("Exit", Common.LOG_CATEGORY, startTicks);
        }
    }
}
