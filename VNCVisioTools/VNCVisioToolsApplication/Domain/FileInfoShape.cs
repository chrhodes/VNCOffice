...
namespace VNCVisioToolsApplication.Domain
{
    public class FileInfoShape
    {
        ...
        public FileInfoShape(MSVisio.Shape activeShape)
        {
            ...
            BranchName = VNCVisioAddIn.Helpers.GetShapePropertyAsString(activeShape, "BranchName");
            BranchRepository = VNCVisioAddIn.Helpers.GetShapePropertyAsString(activeShape, "BranchRepository");
            BranchSourcePath = VNCVisioAddIn.Helpers.GetShapePropertyAsString(activeShape, "BranchSourcePath");
            SolutionName = VNCVisioAddIn.Helpers.GetShapePropertyAsString(activeShape, "SolutionName");
            SolutionFolderPath = VNCVisioAddIn.Helpers.GetShapePropertyAsString(activeShape, "SolutionFolderPath");
            SolutionFileName = VNCVisioAddIn.Helpers.GetShapePropertyAsString(activeShape, "SolutionFileName");
            ProjectName = VNCVisioAddIn.Helpers.GetShapePropertyAsString(activeShape, "ProjectName");
            ProjectFolderPath = VNCVisioAddIn.Helpers.GetShapePropertyAsString(activeShape, "ProjectFolderPath");
            ProjectFileName = VNCVisioAddIn.Helpers.GetShapePropertyAsString(activeShape, "ProjectFileName");
            SourceFileFolderPath = VNCVisioAddIn.Helpers.GetShapePropertyAsString(activeShape, "SourceFileFolderPath");
            SourceFileFileName = VNCVisioAddIn.Helpers.GetShapePropertyAsString(activeShape, "SourceFileFileName");
        }
