...
{
    public class TestVisioLoggingViewModel : EventViewModelBase, ITestVisioLoggingViewModel, IInstanceCountVM
    {
        #region Fields (none)
        ...
        public TestVisioLoggingViewModel(
        ...
        private void InitializeViewModel()
        {
            ...
            Message = "TestVisioLoggingViewModel says hello";
