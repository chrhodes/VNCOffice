...
#if VNCEF
using DemoAndTestLogging5.DomainServices;
#endif

using DemoAndTestLogging5.Presentation.Views;
...
using DemoAndTestLogging5.Core;

namespace DemoAndTestLogging5
{
    public class DemoAndTestLoggingModule : IModule
    {
        private readonly IRegionManager _regionManager;

        // 01

        public DemoAndTestLoggingModule(IRegionManager regionManager)
        {
            Int64 startTicks = 0;
