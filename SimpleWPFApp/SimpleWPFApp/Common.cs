...
namespace SimpleWPFApp
{
    ...
    {
        public const string APPLICATION_NAME = "SimpleWPFApp";
        public new const string LOG_CATEGORY = "SimpleWPFApp";

        public const string cCONFIG_FILE = @"C:\temp\SimpleWPFApp_Config.xml";
