...
namespace VNC.VSTOAddIn.Visio.Presentation.ModelWrappers
{
    public class TextBlockFormatWrapper : ModelWrapper<Domain.TextBlockFormatRow>
    {
        public TextBlockFormatWrapper()
        {
        }
        public TextBlockFormatWrapper(Domain.TextBlockFormatRow model) : base(model)
        {
        }

        public string LeftMargin { get { return GetValue<string>(); } set { SetValue(value); } }
