...
{
    public class ThreeDRotationPropertiesWrapper : ModelWrapper<Domain.ThreeDRotationPropertiesRow>
    {
        public ThreeDRotationPropertiesWrapper()
        {
        }
        public ThreeDRotationPropertiesWrapper(Domain.ThreeDRotationPropertiesRow model) : base(model)
        {
        }
