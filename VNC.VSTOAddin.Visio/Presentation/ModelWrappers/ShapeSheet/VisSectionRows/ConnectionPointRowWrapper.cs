...
{
    public class ConnectionPointRowWrapper : ModelWrapper<Domain.ConnectionPointRow>
    {
        public ConnectionPointRowWrapper() { }

        public ConnectionPointRowWrapper(Domain.ConnectionPointRow model) : base(model)
        {
        }
