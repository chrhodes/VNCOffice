...
namespace VNC.VSTOAddIn.Visio.Domain
{
    ...
    public class CopyOfPagePropertiesRow
    {
        public string PageWidth { get; set; }
        public string PageHeight { get; set; }
        public string PageScale { get; set; }
        ...
        public static CopyOfPagePropertiesRow GetRow(Shape shape)
        {
            CopyOfPagePropertiesRow row = new CopyOfPagePropertiesRow();
        ...
        public static void SetRow(Shape shape, CopyOfPagePropertiesRow pageProperties)
        {
            try
            {
                Section section = shape.Section[(short)VisSectionIndices.visSectionObject];
