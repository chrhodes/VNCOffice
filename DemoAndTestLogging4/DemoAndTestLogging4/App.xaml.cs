...
namespace DemoAndTestLogging4
{
    public partial class App : PrismApplication
    {
...
#endif
            moduleCatalog.AddModule(typeof(DemoAndTestLoggingModule));
        ...
        protected override Window CreateShell()
        {
            ...
            // NOTE(crhodes)
            // The type of view to load into the shell is handled in DemoAndTestLoggingModule.cs
        }
