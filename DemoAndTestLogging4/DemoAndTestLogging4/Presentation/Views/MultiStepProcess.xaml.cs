...
using DemoAndTestLogging4.Presentation.ViewModels;

using VNC;
using VNC.Core.Mvvm;

namespace DemoAndTestLogging4.Presentation.Views
{
    public partial class MultiStepProcess : ViewBase, IMultiStepProcess
    {
        ...
        public MultiStepProcess()
        {
            ...
            // ViewModel = (IMultiStepProcessViewModel)DataContext;

            // Can create directly

            // ViewModel = MultiStepProcessViewModel();
        ...
        public MultiStepProcess(IMultiStepProcessViewModel viewModel)
        {
