...
{
    public partial class RegionNavigation : ViewBase, IRegionNavigation
    {
        ...
        public RegionNavigation()
        {
            ...
            // ViewModel = (IRegionNavigationViewModel)DataContext;

            // Can create directly

            // ViewModel = RegionNavigationViewModel();
        ...
        public RegionNavigation(IRegionNavigationViewModel viewModel)
        {
