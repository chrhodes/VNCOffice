...
{
    public partial class MainDxLayoutControl : ViewBase, IMain
    {
        #region Constructors, Initialization, and Load

        public MainDxLayoutControl()
        {
            Int64 startTicks = 0;
            ...
            // ViewModel = (MainDxLayoutControlViewModel)DataContext;

            // Can create directly

            // ViewModel = new MainDxLayoutControlViewModel();
